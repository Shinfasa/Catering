                    ...
                    <div class="modal fade" id="exampleModalCreate" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                      <div class="modal-dialog">
                        <div class="modal-content">
                          ...
                          <form action="menu.php" method="POST" class="user" enctype='multipart/form-data'>
                          ...
                          <div class="modal-content">
                            ...
                            <form action="menu.php" method="POST" class="user" enctype='multipart/form-data'>
                              <div class="modal-body">
                                ...
                                <div class="form-group">
                                  <label for="txt_gambar">Gambar Menu</label>
                                  <input type="file" class="form-control form-control-menu" placeholder="Gambar Menu" name="txt_gambar">
