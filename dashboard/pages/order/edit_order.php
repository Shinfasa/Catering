                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h5 class="m-0 font-weight-bold">Edit Data Order</h5>
                        </div>
                        <div>
                            <div class="m-4">
                                <form action="edit_user.php" method="POST" class="user">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control form-control-user" placeholder="Nama Customer" name="txt_nama" value="" readonly>
                                    </div>
                                    <div class="form-group">
